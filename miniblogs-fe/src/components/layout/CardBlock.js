    ...
    render() {
        return (
            ...
            <div className="card-body" style={{marginRight : '1.5rem'}}>
              ...
              <p className="card-text">With supporting Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque qui illo quas, soluta consectetur ut quae aperiam excepturi fugiat ab voluptate tempore est architecto? Blanditiis nostrum iure tenetur sed iusto.lorem Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repudiandae, accusamus dolor earum facilis quos doloremque dolorum illum sunt! Modi eligendi natus numquam nisi officiis ab minima nostrum voluptas quae similique?  text below as a natural lead-in to additional content.</p>
            </div>
          </div>
